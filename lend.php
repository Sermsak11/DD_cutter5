...
<body>
  ...
  <div class="container">
    ...
    <div class="jumbotron">
      ...
      <div class="row">
        <div class="col-lg-12 ">
         <h2 class="display-5 text-center">ใบงานทั้งหมด</h2>
         <br>
              ...
              <tr>
               ...
               <td>
                <a <?=$link?> >
                  ...
                  <?php }}?>
                  <?=$book[$i]->book_name?></a> <a href="<?=$book[$i]->book_detail != '' ? $book[$i]->book_detail : '#';?>" target="_blank"><?=$book[$i]->book_detail != '' ? '<span class="badge badge-dark">(ตัวชิ้นงาน)</span>' : '';?></a>
                </td>
                <td>
