			...
			<div class="row">
				...
				<div class="col-lg-6 ">
					...
					<form class="container" action="update_book.php" method="post" id="needs-validation" novalidate enctype="multipart/form-data">
						...
						<div class="row">
							<div class="col-md-12 mb-3">
								<label for="validationCustom06">หมายเหตุ<span style="color: red"> *</span></label>
								<input type="text" class="form-control" id="validationCustom06" placeholder="หมายเหตุ" name="book_techer"  value="<?=$book->book_techer?>" required>
								<div class="invalid-feedback">
									กรุณาระบุหมายเหตุ.
								</div>
							</div>
